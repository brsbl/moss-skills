...
- Bound-reference note and formula IDs must be real 36-character UUIDs. `NOTE_ID`, `H1_ID`, and similar tokens in these examples are placeholders, not valid saved IDs.
